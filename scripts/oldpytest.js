...
async function main() {
  ...
  vault = await upgrades.deployProxy(
    Vault,
    [vaultName, vaultSymbol, weth.address, 0, treasury.address, strategist.address],
    {
      kind: "uups",
    }
  );
  ...
  spiceVault = await upgrades.deployProxy(
    SpiceFi4626,
    [weth.address, strategist.address, assetReceiver.address, 700, strategist.address, strategist.address],
    {
